...
const B1 = ()=> {
    ...
    const [textTime, settextTime] = useState('PICK TIME');
        ...
        return (
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.logoContainer}>
                    <Text style={styles.text}>A Few Steps Further!</Text>
                    <Text style={styles.texttwo}>Hospital Name</Text>
                </View>
                ...
                <View style={styles.bodyContainer}>
                    ...
                    <View style={styles.divider} />
                    <Text style={{ fontSize: Theme.font.medium }}>Time</Text>
                    <TouchableOpacity onPress={()=> showMode('time')} style={styles.inputContainer}>
                    <Text>{textTime}</Text>
                    </TouchableOpacity>
